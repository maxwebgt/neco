...
const SocialIntegration = () => {
  return (
    <section className="py-10 bg-eco-milky">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-2xl font-serif mb-4 text-eco-green">Присоединяйтесь к нам в соцсетях</h3>
          <p className="text-gray-600 mb-6">
            Следите за нами в социальных сетях, чтобы быть в курсе новостей, акций и полезных советов по экологичному образу жизни.
          </p>
          
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              className="bg-[#0088cc] hover:bg-[#0088cc]/90 flex items-center gap-2"
              onClick={() => window.open("https://t.me/ecovery", "_blank")}
            >
            ...
            <Button
              className="bg-[#4C75A3] hover:bg-[#4C75A3]/90 flex items-center gap-2"
              onClick={() => window.open("https://vk.com/ecovery", "_blank")}
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
